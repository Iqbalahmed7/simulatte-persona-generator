"""tests/test_cli_integration.py — Sprint 12 CLI Integration Gate Tests.

Tests the complete generate → save → load → report pipeline.

Dependencies:
  - Tests 1–7: Cursor's persistence module (src/persistence/envelope_store.py)
    and CLI load/report commands.
  - Test 3: Goose's report command wired into cli.py.
  - Test 8: OpenCode's health_wellness.py domain template.
