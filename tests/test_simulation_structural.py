"""tests/test_simulation_structural.py — Non-LLM structural tests for temporal simulation.

Sprint 7 — Codex (Simulation Structural Tests)
Validity Protocol: BV1, BV3, BV6

Tests verify simulation output shape, turn log completeness, and report generation
using mocked run_loop(). No LLM calls are made.

Run with: python -m pytest tests/test_simulation_structural.py
"""
