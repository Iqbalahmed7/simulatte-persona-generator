...
_INDIA_GENERAL_POOL = [
    ...
    ("Suresh Kumar",         32, "male",   "India", "Madhya Pradesh","Bhopal",            "metro",  "other",          3, "lower",   False, "early-career",  "secondary",     "full-time",     "neutral",        "hindu",    "obc"),
    ...
    ("Geetha Rani",          42, "female", "India", "Andhra Pradesh","Vijayawada",        "tier2",  "nuclear",        4, "lower",   False, "mid-career",    "secondary",     "part-time",     "neutral",        "hindu",    "obc"),
    ...
    ("Meena Oram",           48, "female", "India", "Chhattisgarh",  "Raipur",            "tier2",  "nuclear",        5, "lower",   False, "mid-career",    "primary",       "part-time",     "neutral",        "hindu",    "st"),
